...
// 1. REGISTER USER (Instant OTP Response)
...
// 3. FORGOT PASSWORD (Instant Green Box OTP) 🟢
...
const resetPassword = asyncHandler(async (req, res) => {
  ...
  } else { res.status(400); throw new Error('Invalid or Expired OTP'); }
});
