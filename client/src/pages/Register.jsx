  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', background: '#f8fafc', fontFamily: 'Poppins', padding:'20px' }}>
      <div style={{ background: 'white', padding: '30px', borderRadius: '15px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', width: '90%', maxWidth: '400px' }}>
        ...
        <h2 style={{ textAlign: 'center', color: '#1e293b' }}>{step === 1 ? '🚀 Create Account' : '🔐 Verify Email'}</h2>
        ...
        {step === 2 && (
          <div style={{marginTop:'20px'}}>
            <p style={{textAlign:'center', color:'#64748b', fontSize:'0.9rem', marginBottom:'20px'}}>
              We sent a code to <strong>{formData.email}</strong>.<br/>Please check your Inbox and Spam folder.
            </p>
