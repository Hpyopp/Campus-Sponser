                ...
                myChats.length > 0 ? myChats.map((c, i) => (
                    <div 
                        ...
                        style={{ 
                            ...
                            backgroundColor: currentChat?._id === c.user._id ? '#eff6ff' : 'white',
                    ...
                    {messages.map((m, i) => {
                        ...
                        return (
                            <div key={i} style={{ 
                                ...
                                padding: '12px 18px', 
                                borderRadius: '15px', 
                                borderBottomRightRadius: m.sender._id === user._id ? '2px' : '15px',
                                borderBottomLeftRadius: m.sender._id === user._id ? '15px' : '2px',
